...
package pro.rasht.museum.ar.ArModuls;
...
public class HelloAR {
                ...
                if (status == TargetStatus.Tracked) {
                    ...
                    if (tracked_target == 0) {
                        if (video == null && video_renderers.size() > 0) {
                            ...
                            pro.rasht.museum.ar.Model.Target t = AppController.TARGET.get(getTargetId(target_name));
    ...
    private int getTargetId(String target_name) {
        for (pro.rasht.museum.ar.Model.Target t : AppController.TARGET) {
