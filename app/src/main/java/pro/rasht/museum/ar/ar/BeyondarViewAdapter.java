package pro.rasht.museum.ar.ar;
...
/**
 * Adapter to attach pro.rasht.museum.ar.views to the
...
public abstract class BeyondarViewAdapter {
	...
	/**
	 * Override this method to create your own pro.rasht.museum.ar.views from the
