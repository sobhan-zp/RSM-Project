...
public class MapPlaceActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    /**
     * Receiver registered with this activity to get the response from Place_FetchAddressIntentService.
     */
...
*/
        ...
        if (checkPlayServices()) {
            ...
            if (!Place_AppUtils.isLocationEnabled(mContext)) {
                // notify user
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    /**
     * Receiver for data sent from Place_FetchAddressIntentService.
     */
    class AddressResultReceiver extends ResultReceiver {
        ...
        /**
         * Receives data sent from Place_FetchAddressIntentService and updates the UI in MainActivity.
         */
        @Override
        protected void onReceiveResult(int resultCode, Bundle resultData) {

            // Display the address string or an error message sent from the intent service.
            mAddressOutput = resultData.getString(Place_AppUtils.LocationConstants.RESULT_DATA_KEY);

            mAreaOutput = resultData.getString(Place_AppUtils.LocationConstants.LOCATION_DATA_AREA);

            mCityOutput = resultData.getString(Place_AppUtils.LocationConstants.LOCATION_DATA_CITY);
            mStateOutput = resultData.getString(Place_AppUtils.LocationConstants.LOCATION_DATA_STREET);

            displayAddressOutput();

            // Show a toast message if an address was found.
            if (resultCode == Place_AppUtils.LocationConstants.SUCCESS_RESULT) {
    ...
    protected void startIntentService(Location mLocation) {
        ...
        Intent intent = new Intent(this, Place_FetchAddressIntentService.class);

        // Pass the result receiver as an extra to the service.
        intent.putExtra(Place_AppUtils.LocationConstants.RECEIVER, mResultReceiver);

        // Pass the location data as an extra to the service.
        intent.putExtra(Place_AppUtils.LocationConstants.LOCATION_DATA_EXTRA, mLocation);
