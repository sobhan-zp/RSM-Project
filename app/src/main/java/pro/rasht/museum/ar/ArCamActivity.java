...
public class ArCamActivity extends FragmentActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private void Directions_call(){
        ...
        call.enqueue(new Callback<DirectionsResponse>() {
            ...
            public void onFailure(Call<DirectionsResponse> call, Throwable t) {
                ...
                new AlertDialog.Builder(getApplicationContext()).setMessage(getString(R.string.error_fetch)).show();
            }
        });
    }
    ...
    protected void startLocationUpdates() {
        try {
            ...
            Toast.makeText(this,getString(R.string.permission_location),
